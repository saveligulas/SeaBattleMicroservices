...
import sg.spring.seabattle.game.persistence.GameMapNode;
import sg.spring.seabattle.game.persistence.GameMapNodeRelation;
import sg.spring.seabattle.game.persistence.ShipNode;
import sg.spring.seabattle.game.persistence.ShipPartRelation;
...
public class GameMapPersistenceMapper implements IDomainPersistenceMapper<GameMap, GameMapNodeRelation> {
    ...
    public @Nullable GameMap toDomain(@Nullable GameMapNodeRelation entity) {
        ...
        Map<UUID, Set<ShipPartRelation>> shipMap = entity.getMap().getShipParts().stream() //gets ships grouped by their uuid
    ...
    public @Nullable GameMapNodeRelation toEntity(@Nullable GameMap domain) {
        ...
        for (int i = 0; i < domain.getShipParts().length; i++) {
            ...
            shipNode.setId(part.getIdentifier()); //ignore can be null because id will be generated by neo4j if null
